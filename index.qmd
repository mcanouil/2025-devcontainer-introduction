...
- They integrate seamlessly with [Visual Studio Code](https://code.visualstudio.com/) (VS Code) and [GitHub Codespaces](https://github.com/features/codespaces), enabling developers to code, build, and debug inside the container while using their familiar tools.
...
3. Choose "New codespace" to create a new Codespace.
4. GitHub will automatically build the Dev Container based on the `.devcontainer` configuration.
5. Once the Codespace is ready, you can start coding directly in the browser.
...
2. Use the CLI to build and run your Dev Container:
   ...
   devcontainer up --id-label my-container
   devcontainer exec my-container ls
   ```
